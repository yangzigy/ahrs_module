...
static u8 uart1_tx_buf[100];
static u8 uart1_rx_buf[100];
S_UART uart2=
{
	USART2,
};
static u8 uart2_tx_buf[400];
static u8 uart2_rx_buf[100];
S_UART uart3=
{
	USART3,
};
static u8 uart3_tx_buf[25];
static u8 uart3_rx_buf[25];
#ifdef STM32F10X_HD
S_UART uart4=
{
	UART4,
